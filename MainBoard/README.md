...
*По поводу 2 портов. Один из них GPIO0 - его использовать можно только при покдлючении через wifi. Когда подключен Ethernet - увы. Порт занят.
...
[Скачать GEGBER](Url)
В Китае полно сервисов для печати плат, но я предпочитаю пользоваться [jlcpcb.com](https://jlcpcb.com/)
...
- YAML Два [Тестируеться]

### Сборка платы
Схема простая, но при пайке - у новичков могут быть сложности из-за использования smd компонентов в размерности 0805 и плотности их расположения. Рекомендаия одна - желательно иметь не дрожащие руки, и паяльник с тонким жалом)
