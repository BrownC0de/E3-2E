...
Как альтернатива или дополнение к модулю 16IO. Его удобно использовать для подключение бинарных датчиков, с использование защиты порта через опторазвязку. 
