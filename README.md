...
*POE на плате нет, но можно использовать подобного рода [POE сплиттеры](https://aliexpress.ru/item/4000593772054.html)*
...
### 🧩 [Shield 5M (1\2)](/Shield%205M) [Тестирование]
<img src="/MainBoard/images/Shield_5.png" width="600">
Половинчатый модуль с 5 мосфетами, например для светодиодных лент. 
#### Важно! На базовой плате нельзя использовать пины 2, 4, 12, 14, 15, модуль подключается в дополнение к любому из предыдущих формата 1\2, одновременно два - подключить не получиться. 
